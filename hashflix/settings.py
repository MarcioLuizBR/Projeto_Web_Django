...
if TOKEN_CSRF:
    ...
    CRSF_TRUSTED_ORIGINS = ['https://meusite.com.br']
else:
    SECRET_KEY = 'django-insecure-#76s*+x4157z9_9_pzh5j*4@#ydzg587zuf@xc7*1%76238^01'
...
if DATABASE_URL:
    DATABASES = {
        'default': dj_database_url(default=DATABASE_URL, conn_max_age=600)
    }
